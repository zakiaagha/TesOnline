...
public class ActivityTeknikMesin extends AppCompatActivity {

    List<Pertanyaan> pList;
    int nilai=0;
    int id=0;
    int urutanSoal = -1;
    String mapel = "Teknik Mesin";
    String nama;
    String jawaban;
    Pertanyaan currentQ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtPertanyaan = (TextView)findViewById(R.id.txtMesin);
        txtSoalNo = (TextView)findViewById(R.id.soalNoMesin);
        grp = (RadioGroup) findViewById(R.id.radioGroup11);
        pilA = (RadioButton)findViewById(R.id.radio10);
        pilB = (RadioButton)findViewById(R.id.radio11);
        pilC = (RadioButton)findViewById(R.id.radio12);
        pilD = (RadioButton)findViewById(R.id.radio13);
        butNext=(Button)findViewById(R.id.button11);
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    if (id < db.rowcount() ) {
                        ...
                        tampilKotakAlert = new AlertDialog.Builder(ActivityTeknikMesin.this)
                                .create();
                        ...
                        tampilKotakAlert.setButton(AlertDialog.BUTTON_POSITIVE, "Periksa",
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        Intent intent = new Intent(ActivityTeknikMesin.this, ActivityReview.class);
                        ...
                        tampilKotakAlert.setButton(AlertDialog.BUTTON_NEGATIVE, "Keluar",
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        //start intent
                                        Intent intent = new Intent(ActivityTeknikMesin.this, ActivityMain.class);
                                        Bundle b = new Bundle();
