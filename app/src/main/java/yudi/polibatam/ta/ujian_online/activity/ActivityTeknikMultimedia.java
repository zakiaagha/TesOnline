...
public class ActivityTeknikMultimedia extends AppCompatActivity {
    ...
    int urutanSoal = -1;
    String jawaban;
    String mapel = "Teknik Multimedia";
    String nama;
    Pertanyaan currentQ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teknik_multimedia);

        db=new SQLiteHandler(this);
        pList = db.ambilPertanyaan();
        currentQ = pList.get(id);
        txtPertanyaan = (TextView)findViewById(R.id.txtMultimedia);
        txtSoalNo = (TextView)findViewById(R.id.soalNoMultimedia);
        grp = (RadioGroup) findViewById(R.id.radioGroup21);
        pilA = (RadioButton)findViewById(R.id.radio20);
        pilB = (RadioButton)findViewById(R.id.radio21);
        pilC = (RadioButton)findViewById(R.id.radio22);
        pilD = (RadioButton)findViewById(R.id.radio23);
        butNext=(Button)findViewById(R.id.button21);
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    if (id < db.rowcount() ) {
                        ...
                        tampilKotakAlert = new AlertDialog.Builder(ActivityTeknikMultimedia.this)
                                .create();
                        ...
                        tampilKotakAlert.setButton(AlertDialog.BUTTON_POSITIVE, "Periksa",
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        Intent intent = new Intent(ActivityTeknikMultimedia.this, ActivityReview.class);
                        ...
                        tampilKotakAlert.setButton(AlertDialog.BUTTON_NEGATIVE, "Keluar",
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        //start intent
                                        Intent intent = new Intent(ActivityTeknikMultimedia.this, ActivityMain.class);
                                        Bundle b = new Bundle();
